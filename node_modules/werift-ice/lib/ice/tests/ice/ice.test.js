...
class ProtocolMock {
    constructor() {
        ...
        Object.defineProperty(this, "responseAddr", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "responseMessage", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "localCandidate", {
            ...
            configurable: true,
            writable: true,
            value: new candidate_1.Candidate("some-foundation", 1, "udp", 1234, "1.2.3.4", 1234, "host")
        });
        ...
        Object.defineProperty(this, "sendStun", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: async (message) => {
...
describe("ice", () => {
    ...
    test("test_request_with_invalid_method", () => {
        ...
        expect(protocol.sentMessage).not.toBeNull();
        expect(protocol.sentMessage?.messageMethod).toBe(const_1.methods.ALLOCATE);
        expect(protocol.sentMessage?.messageClass).toBe(const_1.classes.ERROR);
    ...
    test("test_connect", async () => {
        ...
        await (0, utils_1.inviteAccept)(a, b);
    ...
    test("test_connect_reverse_order", async () => {
        ...
        await Promise.all([
            new Promise((r) => (0, promises_1.setTimeout)(1000).then(async () => {
                await a.connect();
                r();
            })),
            b.connect(),
    ...
    test("test_connect_invalid_password", async () => new Promise(async (done) => {
        const a = new ice_1.Connection(true);
        const b = new ice_1.Connection(false);
    ...
    test("test_connect_invalid_username", async () => new Promise(async (done) => {
        const a = new ice_1.Connection(true);
        const b = new ice_1.Connection(false);
        await a.gatherCandidates();
        b.remoteCandidates = a.localCandidates;
    ...
    test("test_connect_no_gather", async () => new Promise(async (done) => {
        // """
    ...
    test("test_connect_no_local_candidates", async () => new Promise(async (done) => {
        const conn = new ice_1.Connection(true);
    ...
    test("test_connect_no_remote_candidates", async () => new Promise(async (done) => {
        const conn = new ice_1.Connection(true);
    ...
    test("test_connect_no_remote_credentials", async () => new Promise(async (done) => {
        const conn = new ice_1.Connection(true);
        await conn.gatherCandidates();
        conn.remoteCandidates = [
            candidate_1.Candidate.fromSdp("6815297761 1 udp 659136 1.2.3.4 31102 typ host generation 0"),
    ...
    test("test_connect_role_conflict_both_controlling", async () => {
        const a = new ice_1.Connection(true);
    ...
    test("test_connect_role_conflict_both_controlled", async () => {
    ...
    test("test_connect_with_stun_server", async () => {
        ...
        (0, utils_1.assertCandidateTypes)(a, ["host", "srflx"]);
        (0, utils_1.assertCandidateTypes)(b, ["host", "srflx"]);
        const candidate = a.getDefaultCandidate();
        expect(candidate).not.toBeUndefined();
    ...
    test("test_connect_with_stun_server_dns_lookup_error", async () => {
        const a = new ice_1.Connection(true, {
    ...
    test("test_connect_with_stun_server_ipv6", async () => {
        const a = new ice_1.Connection(true, {
            stunServer: ["stun.l.google.com", 19302],
            useIpv4: false,
            useIpv6: true,
...
describe("sortCandidatePairs", () => {
    it("controlling", () => {
        const host = {
            type: "host",
            localCandidate: { priority: (0, candidate_1.candidatePriority)("host") },
            remoteCandidate: { priority: (0, candidate_1.candidatePriority)("host") },
        };
        const relay = {
            type: "relay",
            localCandidate: { priority: (0, candidate_1.candidatePriority)("relay") },
            remoteCandidate: { priority: (0, candidate_1.candidatePriority)("relay") },
        };
        const res = (0, ice_1.sortCandidatePairs)([host, relay], true);
